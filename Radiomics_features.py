...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 24 19:16:35 2022
...
dossier = '_STCLOUD'
modality = 'T1' # insert name of MRI sequence of interest (e.g. DCE2, ADC, DWI, etc.)
myseg = 'SEG'+dossier        # insert name of segmentation of interest (SEG, DILSEG, EROSEG)
...
df_features = df_features.iloc[: , 37:]
df_features = df_features.apply(lambda x: x.str.replace('.', ','))

"save('/Users/toulsie/Desktop/myfiles/'+modality+myseg+'.npy', df_features)"
